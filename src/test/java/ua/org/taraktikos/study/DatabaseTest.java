...
public class DatabaseTest {
    ...
    public void testImportData() throws Exception {
        ...
        assertFalse(db.importData(inputStream));
    }

    @Test
    public void testParseLine() throws Exception {
        Map<String, String> map = db.parseLine("GB\tB99\tBirmingham\tEngland\tENG\t\t\tBirmingham District (B)\tE08000025\t52.4814\t-1.8998\t4");
